  ...
  return (
    <div className={styles.searchFilterContainer}>
      <div className={styles.searchFilterItem}>
        <input className={styles.searchFilterInput} id='dairyFree' type='checkbox' value='dairy-free' checked={searchFilterValues.isDairyFree} onChange={handleSearchFilterValuesChange}></input>
        <label htmlFor='dairyFree'>Dairy free</label>
      </div>
      <div className={styles.searchFilterItem}>
        <input className={styles.searchFilterInput} type='checkbox' value='gluten-free' checked={searchFilterValues.isGlutenFree} onChange={handleSearchFilterValuesChange}></input>
        <label htmlFor='glutenFree'>Gluten free</label>
      </div>
      <div className={styles.searchFilterItem}>
        <input className={styles.searchFilterInput} type='checkbox' value='vegetarian' checked={searchFilterValues.isVegetarian} onChange={handleSearchFilterValuesChange}></input>
        <label htmlFor='vegetarian'>Vegetarian</label>
      </div>
      <div className={styles.searchFilterItem}>
        <input className={styles.searchFilterInput} type='checkbox' value='vegan' checked={searchFilterValues.isVegan} onChange={handleSearchFilterValuesChange}></input>
